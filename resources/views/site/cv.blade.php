...
<head>
        ...
        <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('cv/assets/images/apple-icon-72x72.png') }}">
        <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('cv/assets/images/apple-icon-76x76.html') }}">
        <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('cv/assets/images/apple-icon-114x114.png') }}">
        ...
        <link rel="stylesheet" href="{{ asset('cv/assets/css/materialize.min.css') }}">
        <!-- ADDITIONAL CSS -->
        <link rel="stylesheet" href="{{ asset('cv/assets/css/animate.css') }}">
        ...
        <!-- COLORS -->
        <link rel="alternate stylesheet" href="{{ asset('cv/assets/css/colors/red.css') }}" title="red">
        ...
        <link rel="stylesheet" href="{{ asset('cv/assets/css/colors/lime.css') }}" title="lime">


        <!-- STYLE SWITCH STYLESHEET ONLY FOR DEMO -->
        <link rel="stylesheet" href="{{ asset('cv/assets/css/demo.css') }}">
        <!--=====================
                       JavaScript
               ===================== -->
               <!-- Jquery core js-->
               <script src="{{ asset('cv/assets/js/jquery.min.js') }}"></script>

               <!-- materialize js-->
               <script src="{{ asset('cv/assets/js/materialize.min.js') }}"></script>

               <!-- wow js-->
               <script src="{{ asset('cv/assets/js/wow.min.js') }}"></script>


               <!-- Masonry js-->
               <script src="{{ asset('cv/assets/js/masonry.pkgd.js') }}"></script>

               <script src="{{ asset('cv/assets/js/validator.min.js') }}"></script>

               <!-- Customized js -->
               <script src="{{ asset('cv/assets/js/init.js') }}"></script>
               ...
               <!-- Style switter js -->
               <script src="{{ asset('cv/assets/js/styleswitcher.js') }}"></script>
